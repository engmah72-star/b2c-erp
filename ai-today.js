...
export const PAGE_FOCUS = {
  ...
  'job-orders.html':   'أوامر التشغيل. ركّز على المسارات والحالات والمتأخر.',
  'product-pricing.html': 'تسعير المنتجات. ركّز على الهامش وفروق التكلفة.',
  'smart-pricing.html':   'التسعير الذكي. ركّز على بنود التكلفة وأثرها على الهامش.',
