...
(function(){
  ...
  function showBanner(mode) {
    ...
    style.textContent = ''
      ...
      + '#pwa-install-banner .pwa-ico{font-size:28px;flex-shrink:0;line-height:1}'
      + '#pwa-install-banner .pwa-body{flex:1;min-width:0}'
      + '#pwa-install-banner .pwa-title{font-size:13px;font-weight:800;color:#fff;margin-bottom:2px}'
      + '#pwa-install-banner .pwa-sub{font-size:11px;color:#a8b4cc;line-height:1.5}'
