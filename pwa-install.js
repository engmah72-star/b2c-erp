...
(function(){
  ...
  function showBanner(mode) {
    ...
    style.textContent = ''
      ...
      + '#pwa-install-banner .pwa-title{font-size:var(--fs-md);font-weight:800;color:#fff;margin-bottom:var(--space-2xs)}'
      + '#pwa-install-banner .pwa-sub{font-size:var(--fs-sm);color:#a8b4cc;line-height:1.5}'
