...
function ensureStyle() {
  ...
  s.textContent = `
    #${CHIP_ID}{display:inline-flex;align-items:center;gap:6px;padding:6px 12px;
      ...
      border:1px solid rgba(16,185,129,.35);border-radius:18px;color:var(--g-emerald);
      font-size:var(--fs-sm);font-weight:var(--fw-extra);cursor:pointer;font-family:inherit;
    ...
    #${OV_ID} .panel{background:#161b27;color:#e8eaf0;border:1px solid var(--bg-blue);
    ...
    #${OV_ID} textarea{width:100%;background:var(--bg-card);border:1px solid var(--bg-blue);border-radius:var(--rad);
    ...
    #${OV_ID} textarea:focus{border-color:var(--g-emerald)}
    #${OV_ID} .examples{display:flex;gap:6px;flex-wrap:wrap;margin-top:10px}
    #${OV_ID} .ex{padding:6px 10px;background:var(--bg-card);border:1px solid var(--bg-blue);
      border-radius:18px;font-size:var(--fs-sm);color:#8892a4;cursor:pointer;transition:.15s}
    #${OV_ID} .ex:hover{border-color:var(--g-emerald);color:var(--g-emerald)}
    #${OV_ID} .row{display:flex;gap:var(--space-sm);margin-top:14px;align-items:center}
    #${OV_ID} .btn-apply{flex:1;padding:10px;background:var(--g-emerald);color:#fff;border:none;
    ...
    #${OV_ID} .btn-cancel{padding:10px 14px;background:var(--bg-card);color:#8892a4;
      border:1px solid var(--bg-blue);border-radius:var(--rad);font-size:var(--fs-base);cursor:pointer;font-family:inherit}
    #${OV_ID} .status{font-size:var(--fs-sm);color:#8892a4;margin-top:10px;min-height:14px}
    #${OV_ID} .status.err{color:#f87171}
    #${OV_ID} .status.ok{color:var(--g-emerald)}
  `;
