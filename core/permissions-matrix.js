...
export const DEFAULT_ROLE_PERMISSIONS = Object.freeze({
  ...
  customer_service: {
    pages: ['clients', 'design', 'cs-dashboard', 'order-rail'],
  ...
  graphic_designer: {
    pages: ['design', 'designer-dashboard', 'order-rail'],
  ...
  production_agent: {
    pages: ['production', 'production-dashboard', 'cost-items-library', 'order-rail'],
    canSeePrices: false, canSeeAllOrders: false, canAddOrders: false,
    canViewClients: false, canAddClients: false,
    canAssignDesigner: false, canAssignTasks: false,
  ...
  shipping_officer: {
    pages: ['shipping', 'shipping-dashboard', 'shipping-accounts', 'shipping-followup', 'order-rail'],
    canSeePrices: false, canSeeAllOrders: false, canAddOrders: false,
