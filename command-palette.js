...
(function() {
  ...
  function injectStyles() {
    ...
    s.textContent = ''
      ...
      + '.cp-section{padding:8px 14px 4px;font-size:10.5px;color:var(--dim2,#5c6878);font-weight:var(--fw-extra);letter-spacing:.4px}'
      + '.cp-item{display:flex;align-items:center;gap:10px;padding:9px 16px;cursor:pointer;color:var(--snow,#e8eaf0);font-size:var(--fs-md);font-weight:var(--fw-semi);transition:background .08s}'
